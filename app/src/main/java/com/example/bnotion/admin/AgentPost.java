...
public class AgentPost extends BlogPostId implements Serializable {
    @Exclude
    private String id;
    public String image_url,  profile_url, title, category, location, price, number_of_toilets, number_of_baths, state, user_id, username, mobile_number, status, price_range, email, desc;
    ...
    public AgentPost(String image_url, String title, String category, String location, String price, String number_of_toilets, String number_of_baths, String state, String user_id, String username, String mobile_number, String status, String email, String desc, String profile_url, String price_range, Date timestamp, ArrayList<String> image_urls) {
